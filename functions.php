...
function wp_classic_theme_starter_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'wp-classic-theme-starter' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'wp_classic_theme_starter_custom_background_args',
			array(
 ...
 */
function wp_classic_theme_starter_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'wp-classic-theme-starter' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'wp-classic-theme-starter' ),
...
add_action( 'widgets_init', 'wp_classic_theme_starter_widgets_init' );
...
function wp_classic_theme_starter_scripts() {
	...
	wp_enqueue_script( 'wp-classic-theme-starter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), WP_CLASSIC_THEME_STARTER_VERSION, true );
